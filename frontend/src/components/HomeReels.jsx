                ...
                >
                    ...
                    <div className="absolute right-6 bottom-36 flex flex-col items-center gap-5 z-10">
                        ...
                        >
                            ...
                            <span className="text-white/80 text-[11px] font-medium">likes : {reel.likes || 23}</span>
                        </button>
                        ...
                        >
                            ...
                            <span className="text-white/80 text-[11px] font-medium">Save : {reel.saves || 23}</span>
                        </button>
                        ...
                        <button className="flex flex-col items-center gap-1 group">
                            ...
                            <span className="text-white/80 text-[11px] font-medium">Comment:{reel.comments || 45}</span>
                        </button>
                    </div>
